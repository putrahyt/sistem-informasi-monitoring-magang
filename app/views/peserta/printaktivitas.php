    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 30%;">Catatan Dari Mentor</th>
                <th style="width: 5%;">Status Aktivitas</th>
            </tr>
        </thead>
        <tbody>
            <?php $i=1 ?>
            ...
            <tr>
                ...
                <?php if($aktivitas['status'] == 0) : ?>
                    <td style="text-align: left;" title="Proses">Proses</td>
                <?php elseif($aktivitas['status'] == 1) : ?>
                    <td style="text-align: left;" title="Acc">Acc</td>
                <?php else : ?>
                    <td style="text-align: left;" title="Ditolak">Ditolak</td>
                <?php endif ?>
            </tr>
            <?php $i++ ?>
            <?php endforeach ?>
