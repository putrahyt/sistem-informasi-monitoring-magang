<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" href="<?= BASEURL ?>/tamu">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= BASEURL ?>/tamu/search">
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Aktivitas & Absensi</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?= BASEURL ?>/tamu">Home</a></li>
          <li class="breadcrumb-item active">Aktivitas & Absensi Peserta</li>
        </ol>
      </nav>
    </div>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-4">Pilih Pencarian</h5>
                <form action="<?= BASEURL ?>/tamu/search" class="row g-3 needs-validation" method="post" novalidate>
                    <div class="row mb-3">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-sm-11">
                  <h5 class="card-title"><?= $data['laporan'] ?> Peserta <small>(<?= $data['tanggalAwal'] . ' s.d ' . $data['tanggalAkhir']?>)</small></h5>
                </div>
              </div>
              <hr>
              <div class="row mb-3">
