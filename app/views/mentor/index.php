<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?= BASEURL ?>/mentor">
          ...
          <div class="row"> 
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card blue-card">
                <div class="card-body">
                  ...
                  <a href="<?= BASEURL ?>/mentor/datapeserta">
            ...
            <div class="col-xxl-3 col-md-6">
              <div class="card info-card green-card">
                <div class="card-body">
                  <h5 class="card-title">Total Aktivitas Peserta</h5>
                  <a href="<?= BASEURL ?>/mentor/aktivitas">
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <i class="bi bi-journal-check"></i>
                    </div>
              ...
              <table class="table table-bordered table-responsive-sm table-sm">
                <thead>
                  <tr class="table-secondary">
                    ...
                    <th scope="col" style="width: 18%; vertical-align:middle; text-align:center">Tanggal</th>
                    <th scope="col" style="width: 25%; vertical-align:middle; text-align:center">Nama</th>
