<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= BASEURL ?>/mentor/laporan">
        ...
        <div class="col-lg-8">
          <div class="card">
            <div class="card-body">
                ...
                <form action="<?= BASEURL ?>/mentor/laporan" class="row g-3 needs-validation" method="post" novalidate>
                    <div class="row mb-3">
                ...
                <div class="col-sm-1 mt-3">
                  <?php 
                    if($data['laporan'] == 'Absensi') {
                      $url = BASEURL . '/mentor/printabsensi';
                    } else if($data['laporan'] == 'Aktivitas') {
                      $url = BASEURL . '/mentor/printaktivitas';
                    }
                  ?>
