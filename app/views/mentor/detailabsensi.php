    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?= BASEURL ?>/mentor/absensi">Absensi</a></li>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9"><input type="text" class="form-control" value="<?= $data['absensi']['fullname_peserta'] ?>" readonly disabled></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-3"><label class="col-form-label fw-bold">Instansi</label></div>
                        <div class="col-sm-9"><input type="text" class="form-control" value="<?= $data['absensi']['instansi'] ?>" readonly disabled></div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-3"><label class="col-form-label fw-bold">Divisi Magang</label></div>
                        <div class="col-sm-9"><input type="text" class="form-control" value="<?= $data['absensi']['divisi_magang'] ?>" readonly disabled></div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-5"><a href="<?= BASEURL . '/mentor/absensi' ?>" class="btn btn-danger mt-2">Kembali</a></div>
                    </div>
                  </div>
                </div>
            </div>
